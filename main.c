...
// NOTE: This is the only difference between bootloader for Arduino Primo and Arduino Primo Core
//#define BOOTLOADER_BUTTON               7 //USER1_BUTTON (Primo)                                           /**< Button used to enter SW update mode. */
#define BOOTLOADER_BUTTON               31  //D0 (Primo Core)                                            /**< Button used to enter SW update mode. */
